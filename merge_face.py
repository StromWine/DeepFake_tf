...
def convert_one_image(args, new_face_rgb, new_face_m, sourceFace, image, mat):
    ...
    new_face_m = numpy.clip(new_face_m[0], 0, 1).astype(float) * numpy.ones(
        (new_face_m.shape[0], new_face_m.shape[1], 3))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_dir", type=str, nargs='?', default='./image/image_3')
    ...
    parser.add_argument("--aligned_path", type=str, nargs='?', default='./image/image_3/aligned')
    parser.add_argument("--seamlessClone", type=str2bool, nargs='?', const=False, default='False',
                        help="Attempt to use opencv seamlessClone.")

    parser.add_argument("--doublePass", type=str2bool, nargs='?', const=False, default='True',
